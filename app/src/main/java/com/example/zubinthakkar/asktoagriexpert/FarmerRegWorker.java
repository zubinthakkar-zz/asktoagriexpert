...
class FarmerRegWorker extends AsyncTask<String,Void,String> {
    Context context;
    AlertDialog alertDialog;
    FarmerRegWorker (Context ctx){
    ...
    protected String doInBackground(String... params) {
        ...
        String Freg_url = Url.URL+"addfarmer.php";
        if(type.equals("FRegister"))
        {
    ...
    protected void onPostExecute(String result) {
        ...
        if(result.toString().equals("Register Successfull"))
        {
